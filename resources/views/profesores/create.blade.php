            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('profesores.store') }}" class="needs-validation" novalidate>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control shadow-sm @error('nombre') is-invalid @enderror"
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control shadow-sm @error('dni') is-invalid @enderror"
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select shadow-sm @error('genero') is-invalid @enderror"
                                        ...
                                        @foreach($generos as $key => $genero)
                                            <option value="{{ $key }}" {{ old('genero') == $key ? 'selected' : '' }}>{{ $genero }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="id_localidad"
                                        class="form-select shadow-sm @error('id_localidad') is-invalid @enderror" required>
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                <label class="fw-bold">Disponibilidad Horaria</label>
                                <div class="input-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control shadow-sm @error('estado') is-invalid @enderror"
                                        ...
                                        @foreach($estados as $key => $estado)
                                            <option value="{{ $key }}" {{ old('estado') == $key ? 'selected' : '' }}>{{ $estado }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
